...
class RegistrationController: UIViewController {
    ...
    private let alreadyHaveAccountButton: UIButton = {
        ...
        attributedTitle.append(NSAttributedString(string: "Login",attributes: [.font:                                       UIFont.boldSystemFont(ofSize: 16),.foregroundColor: UIColor.white]))
    ...
    @objc func handleRegistration() {
        ...
        let credentials = RegistrationCredentials(email: email, password: password, fullname: fullname, username: username, profileImage: profileImage)
         ...
         showLoader(true, withText: "Registering You Up")
...
//Pranav: - UIImagePickerControllerDelegate
